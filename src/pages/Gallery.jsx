  ...
  projects: [
    {
      id: 1,
      caption:
        "Every screenshot tells a story of consistency, effort, and growth 💻✨.",
      photos: [
        "/gallery/project_screenshot (1).png",
        "/gallery/project_screenshot (2).png",
        "/gallery/project_screenshot (3).png",
        "/gallery/project_screenshot (4).png",
        "/gallery/project_screenshot (5).png",
        "/gallery/project_screenshot (6).png",
        "/gallery/project_screenshot (7).png",
        "/gallery/project_screenshot (8).png",
        "/gallery/project_screenshot (9).png",
      ],
    },
  ],
  achievements: [
    {
      id: 1,
      caption: "Crossed 1400+ GitHub commits 🚀 Growth is a habit now🏆!",
      photos: ["/gallery/achivement.png"],
    },
  ],
};
